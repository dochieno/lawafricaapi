...
{
    /// <summary>
    /// Used by admins to update content products via Swagger / Admin UI.
    /// </summary>
    public class UpdateContentProductRequest
    {
        ...
        /// Note: only meaningful if the corresponding access model is Subscription.
        /// </summary>
